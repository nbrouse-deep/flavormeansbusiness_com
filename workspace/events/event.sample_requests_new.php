<?php
	...
	Class eventsample_requests_new extends SectionEvent{

		public $ROOTELEMENT = 'sample-requests-new';
		...
		public static function about(){
			return array(
				'name' => 'Sample Requests: New',
				'author' => array(
					'name' => 'sugar design studio',
					'website' => 'http://flavormeansbusiness.dev',
					'email' => 'adam@sugards.com'),
				'version' => 'Symphony 2.3',
				'release-date' => '2013-03-19T18:19:36+00:00',
				'trigger-condition' => 'action[sample-requests-new]'
			);
		}
        ...
        <pre class="XML"><code>&lt;sample-requests-new result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/sample-requests-new></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;sample-requests-new result="error">
...
&lt;/sample-requests-new></code></pre>
  ...
  &lt;/label>
  &lt;input name="action[sample-requests-new]" type="submit" value="Submit" />
&lt;/form></code></pre>
...
&lt;/form></code></pre>';
		...
		public function load(){
			if(isset($_POST['action']['sample-requests-new'])) return $this->__trigger();
		}
