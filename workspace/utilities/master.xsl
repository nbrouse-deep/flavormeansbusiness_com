...
<xsl:import href="bootscripts.xsl" />
        ...
        <body class="{$root-page}" id="{$current-page}">
            ...
            <div class="container">
                <div class="site-search">
                    <p class="see-how-fmb">
                        <a href="http://flavormeansbusiness.com/workspace/assets/brochures/pdf/minors-rtu-flavor-matrix.pdf"> Easily add flavor to your menu by using our <em>RTU Plus-One Matrix</em></a>
                            ...
                            <section class="contact">
                                ...
                                <div class="left">
                                    ...
                                    <dl>
                                        ...
                                        <dd class="chat">
                                            <a href="http://chat11.archway.com/WebChat/Main.aspx?QueueName=CHAT-NESTLE-P">Chat live with a <em>Minor's</em> expert</a>
                                        </dd>
                                    </dl>
                                </div>
                            </section>
